#!/usr/bin/env python3
"""Build a deterministic bbk-profile-typescript-javascript zip and companions."""
...
def build_manifest() -> dict[str, Any]:
    ...
    fixture_count = len([path for path in (ROOT / "fixtures").iterdir() if path.is_dir()]) if (ROOT / "fixtures").is_dir() else 0
    return {
        ...
        "skill_count": len(PROFILE["skills"]), "fixture_count": fixture_count,
        "authority_disclaimer": "This optional BBK profile adds procedure, review criteria, and gate recipes; it grants no tools, effects, completion, readiness, acceptance, or release authority.",
    }
