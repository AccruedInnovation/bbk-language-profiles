# BBK Python Profile 0.1.0-alpha.3 release notes
...
- The structure-contract validator requirement is now version-neutral and capability-aware; newer BBK alphas and stable successors are no longer rejected as older than alpha.4.
- The default compatibility version is now read directly from `PROFILE.json.requires.bbk_minimum`; no alpha.4 compatibility fallback remains.
