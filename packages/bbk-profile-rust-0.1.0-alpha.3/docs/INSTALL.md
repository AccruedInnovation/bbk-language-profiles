...
- BBK core `0.1.0-alpha.8` or compatible successor;
...
```bash
sha256sum -c bbk-profile-rust-0.1.0-alpha.3.sha256
unzip -q bbk-profile-rust-0.1.0-alpha.3.zip
cd bbk-profile-rust-0.1.0-alpha.3
